...
/// This proc macro allows to specify which RedisModuleAPI is required by some redismodue-rs
/// function. The macro finds, for a given set of RedisModuleAPI, what os the minimal Redis version
