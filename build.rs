...
fn main() {
    ...
    let bindings = bindings_generator
        ...
        // .blocklist_function("RedisModule_CreateStringFromLongDouble")
        // .blocklist_function("RedisModule_ReplyWithLongDouble")
        // .blocklist_function("RedisModule_StringToLongDouble")
        // .blocklist_function("RedisModule_SaveLongDouble")
        // .blocklist_function("RedisModule_LoadLongDouble")
