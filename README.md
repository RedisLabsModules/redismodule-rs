...
[![macos](https://github.com/RedisLabsModules/redismodule-rs/workflows/macos/badge.svg)](https://github.com/RedisLabsModules/redismodule-rs/actions?query=workflow%3Amacos)
...
3. Run `cargo build --example hello` or `cargo build --all-features --example timer` for experimental-api examples.
